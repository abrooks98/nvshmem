...
NVSHMEMI_ENV_DEF(PROXY_BATCH_FLUSH_INTERVAL, int, 16, NVSHMEMI_ENV_CAT_OTHER,
                 "Flush the batch of similar requests every N consecutive ops. This is only "
                 "relevant for transports which implement the batch_hint host op.")
